...
namespace ProceduralCubemapApi.Common.PlanetModification.Persistence
{
    internal sealed class RuntimePackageStore
    {
        ...
        private const string RECIPE_VARIABLE_PREFIX =
            "CubemapApi.RuntimePersistence.v2.Recipe.";
        ...
        private readonly CubemapApiServer _server;
        private readonly CubemapApiConfig _config;
